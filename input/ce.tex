...
\end{equation}
with $\beta_{pp}(\omega) = \frac{1}{\pi} |\operatorname{Im} \Sigma_{pp}(\omega + \epsilon_p)|$ with the self-energy defined as
\begin{align}
    \Sigma^{(2)}_{pq}(\omega)
