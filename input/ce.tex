...
\langle 0|\hat{\beta}_\mu \hat{\beta}_\nu^\dagger|0\rangle\\
&= \sum_{\nu} |M_{p\nu}|^2\;e^{-i\Omega_\nu (t_1-t_2)}.
% &= \sum_{\nu,\nu'} W_{p\nu}W_{p\nu'}
% \langle \Psi_p|\,\hat{n}_p\hat{n}_p\,
% \big(e^{+i\Omega_\nu t_1}\hat{b}_\nu^\dagger + e^{-i\Omega_\nu t_1}\hat{b}_\nu\big)\nonumber\\
...
\end{equation}
where $C^{MP2}$ is given by eqn.~\ref{eq:cumulant_2nd_2} with the single particle energies and two-electron integrals evaluated at the HF level.
