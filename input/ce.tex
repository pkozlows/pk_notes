...
\section{Annotation of Loos paper}
...
\subsection{Using exact self-energy}
...
\subsection{Off-diagonal cumulant with GW self-energy}
We can start with
\begin{align}
...
%     C_{pq}(t) &= \frac{i}{\Delta_{pq}} \int \frac{d\omega}{2\pi} e^{-i\omega t} \Sigma_{pq}^c(\omega + \epsilon_p^{HF}) \left(\frac{1}{\omega + i\eta} - \frac{1}{\omega + \Delta_{pq} + i\eta}\right) \\
% \end{align}
% Now, we can just plug this in to the expression for the retarded Green's function to get
% \begin{align}
%     G_{pq}(t) & = G_{pq}^{HF}(t) e^{C_{pq}(t)} \\
% & = -i \Theta(t) e^{-i \epsilon_p^{HF} t + C_{pq}(t)} \\
% & = -i \Theta(t) e^{-i \epsilon_p^{HF} t} \exp\left[\frac{i}{\Delta_{pq}} \int \frac{d\omega}{2\pi} e^{-i\omega t} \Sigma_{pq}^c(\omega + \epsilon_p^{HF}) \left(\frac{1}{\omega + i\eta} - \frac{1}{\omega + \Delta_{pq} + i\eta}\right)\right]
% \end{align}
...
\end{align}
\section{Annotation of CC Cumulant Green's function paper}
...
\subsection{Equivalence between the second order self-energy and the CC retarded Green's function}
