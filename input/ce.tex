...
\begin{align}
G_{pp}(\omega)
&= \int_{-\infty}^{\infty} dt\, e^{i \omega t} G_{pp}(t) \\
&= \int_{-\infty}^{\infty} dt\, e^{i \omega t} \left( -i\, \Theta(t)\, e^{-i \epsilon_p t}\, e^{C_{pp}^{(2)}(t)} \right) \\
&= -i \int_0^\infty dt\,
\exp\!\Biggl[
  i(\omega - \epsilon_p)t
  + \tfrac{1}{2}
  \Biggl(
    \sum_{iab}
      \langle pi \Vert ab \rangle^2
      \int \frac{d\omega'}{2\pi}\,
      \frac{i\, e^{-i \omega' t}}
           {(\omega')^2\!\left(\omega' - \epsilon_{pi}^{ab}\right)}
    + 
    \sum_{ija}
      \langle pa \Vert ij \rangle^2
      \int \frac{d\omega'}{2\pi}\,
      \frac{i\, e^{-i \omega' t}}
...
\exp\!\Biggl[
  ...
  + \tfrac{1}{2}
  \Biggl(
\sum_{iab} \frac{\left< pi \left| \right| ab \right>^2}{\left(\epsilon_{pi}^{ab}\right)^2}
\left(e^{-i \epsilon_{pi}^{ab} t} +i \epsilon_{pi}^{ab} t -1 \right)+\sum_{ija} \frac{\left< pa \left| \right| ij \right>^2}{\left(\epsilon_{pa}^{ij}\right)^2}
\left(e^{-i \epsilon_{pa}^{ij} t} +i \epsilon_{pa}^{ij} t -1 \right) 
  \Biggr)
\Biggr]
\label{eq:sc_cumulant_greens_freq} \\
\end{align}
