...
\end{align}
where $\bar{H} = e^{-\hat{T}} \hat{H} e^{\hat{T}}$ is the similarity-transformed Hamiltonian. Differentiating the functional with respect to $z_q$ gives
\begin{align}
...
&=\langle\Phi_q| e^{\hat{Z}} \bar{H} |\Phi_0\rangle \\
&=\langle\Phi_q| e^{\hat{Z}} e^{-\hat{T}} \hat{H} e^{\hat{T}} |\Phi_0\rangle.
\end{align}
Differentiating with respect to $t_q$ gives
\begin{align}
