...
\begin{figure}[h!]
  ...
  \caption{Spectral functions of the UEG at the $\Gamma $ point for $r_s = 4$. Curves are shown for BWs2+C (where we set $\alpha_1 = 2$ and $\alpha_2 = 0$), GW+C ($G_0$ from DFT-LDA), and EOM-CCSD, with the latter two reproduced from \citet{McClain2016-md}. This UEG supercell contains 114 electrons in 485 orbitals.}
  \label{fig:bws2_pqe}
\end{figure}
